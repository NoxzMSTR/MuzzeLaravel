	...
	<!-- imageGalleryBlock -->
	<section class="imageGalleryBlock pt-8 pb-3 pb-md-6 pt-lg-13 pb-lg-10 pt-xl-19 pb-xl-21">
		<div class="container">
			<!-- ogFiltersList -->
		...
		<div class="container-fluid px-0">
			...
			<div class="row no-gutters isoContentHolder">
				<div class="col-12 col-sm-4 col-xl-3 objects isoCol">
					<!-- galFig -->
					<figure class="galFig galFigII position-relative mx-auto mx-md-0 mb-0">
