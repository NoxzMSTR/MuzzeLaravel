            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="current" role="tabpanel" aria-labelledby="current-tab">
                    <div class="row">
                        <div class="col-12">
                            <!-- currExibitColumn -->
                            <article class="currExibitColumn gridView d-flex mb-6 mb-lg-9 mb-xl-12 mx-auto">
                                <div class="imgHolder flex-shrink-0 mr-4 mr-lg-6 mr-xl-8">
                                    <a href="{{route('single-exhibition')}}">
                                        <img src="http://via.placeholder.com/205x150" class="img-fluid w-100 d-block"
                                ...
                                <div class="descrWrap pt-md-2 pt-lg-5">
                                    ...
                                    <time datetime="2011-01-12" class="d-block cecTime text-gray777">13 Oct 2018 - 15 Feb
                                        2019</time>
                                </div>
                            </article>
                        </div>
                        <div class="col-12">
                            ...
                            <article class="currExibitColumn gridView d-flex mb-6 mb-lg-9 mb-xl-12 mx-auto">
                                ...
                                <div class="descrWrap pt-md-2 pt-lg-5">
                                    ...
                                    <time datetime="2011-01-12" class="d-block cecTime text-gray777">Open 12:30 - 1:00
                                        Daily</time>
                                </div>
                            </article>
                        </div>
                        <div class="col-12">
                            ...
                            <article class="currExibitColumn gridView d-flex mb-6 mb-lg-9 mb-xl-12 mx-auto">
                                ...
                                <div class="descrWrap pt-md-2 pt-lg-5">
                                    ...
                                    <time datetime="2011-01-12" class="d-block cecTime text-gray777">25 Oct 2018 - 10 May
                                        2019</time>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <article class="currExibitColumn gridView d-flex mb-6 mb-lg-9 mb-xl-12 mx-auto">
                                ...
                                <div class="descrWrap pt-md-2 pt-lg-5">
                                    ...
                                    <time datetime="2011-01-12" class="d-block cecTime text-gray777">18 Sep 2018 - 15 Mar
                                        2019</time>
                                </div>
                            </article>
                        </div>
                    ...
                    <div class="btnHolder text-center">
                        <a href="{{route('single-exhibition')}}" class="btn laodMore btn-outline-light bdr2 btnLgMinWidth">Load
                            More</a>
                    </div>
                </div>
                <!-- upcoming-tab -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <article class="currExibitColumn gridView d-flex mb-6 mb-lg-9 mb-xl-12 mx-auto">
                                ...
                                <strong
                                    class="catagoryTitle d-block font-weight-normal text-uppercase mb-2">Exhibition</strong>
                                <h2 class="mb-1 mb-sm-3">
                                    <a href="{{route('single-exhibition')}}">Mutiny: Works by Géricault</a>
                                </h2>
                                <time datetime="2011-01-12" class="d-block cecTime text-gray777">13 Oct 2018 - 15 Feb
                        ...
                        <div class="col-12">
                            ...
                            <article class="currExibitColumn gridView d-flex mb-6 mb-lg-9 mb-xl-12 mx-auto">
                                ...
                                <strong class="catagoryTitle d-block font-weight-normal text-uppercase mb-2">Now On
                                    view</strong>
                                <h2 class="mb-1 mb-sm-3">
                                    <a href="{{route('single-exhibition')}}">The Upstairs Room of A art Taminiau</a>
                                </h2>
