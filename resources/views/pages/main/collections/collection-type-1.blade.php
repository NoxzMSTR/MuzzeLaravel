                ...
                <ul class="nav nav-tabs justify-content-center exhiTabList exhiTabListIII mt-4 mt-lg-8 pb-8" role="tablist">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);" role="button"
                            aria-haspopup="true" aria-expanded="false">Artist <i class="fas fa-angle-down icn"><span
                                    class="sr-only">icon</span></i></a>
                        <!-- fltDropdown -->
                        <div class="dropdown-menu py-0 bg-secondary fltDropdown">
                            <a class="dropdown-item" id="current-tab" data-toggle="tab" href="#current" role="tab"
                                aria-controls="current" aria-selected="true">Ghada Amer &amp; Reza (22)</a>
                            <a class="dropdown-item" id="upcoming-tab" data-toggle="tab" href="#upcoming" role="tab"
                                aria-selected="true">Beom Kim (13)</a>
                            <a class="dropdown-item" id="past-tab" data-toggle="tab" href="#past" role="tab"
                                aria-selected="true">Tan Swie Hian (12)</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);" role="button"
                            aria-haspopup="true" aria-expanded="false">Location <i class="fas fa-angle-down icn"><span
                                    class="sr-only">icon</span></i></a>
                        <!-- fltDropdown -->
                        <div class="dropdown-menu py-0 bg-secondary fltDropdown">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);" role="button"
                            aria-haspopup="true" aria-expanded="false">Period <i class="fas fa-angle-down icn"><span
                                    class="sr-only">icon</span></i></a>
                        <!-- fltDropdown -->
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);" role="button"
                            aria-haspopup="true" aria-expanded="false">Type <i class="fas fa-angle-down icn"><span
                                    class="sr-only">icon</span></i></a>
                        <!-- fltDropdown -->
                        <div class="dropdown-menu py-0 dropdown-menu-right bg-secondary fltDropdown">
                            <a class="dropdown-item" href="javascript:void(0);">Ghada Amer &amp; Reza (22)</a>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="current" role="tabpanel" aria-labelledby="current-tab">
                    ...
                    <div class="row makeItMasonery mx-xl-n4">
                            ...
                            <article class="collectionColumn mb-6 mb-xl-8 text-center position-relative">
                                <div class="imgHolder">
                                    <a href="single-works.html">
                                        <img src="http://via.placeholder.com/365x290" class="img-fluid w-100 d-block"
                                            alt="image description">
                                        <div
                                            class="ccCaption position-absolute bg-white d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 mimItem px-xl-4">
                            ...
                            <article class="collectionColumn mb-6 mb-xl-8 text-center position-relative">
                                <div class="imgHolder">
                                    <a href="single-works.html">
                                        <img src="http://via.placeholder.com/365x480" class="img-fluid w-100 d-block"
                                            alt="image description">
                                        <div
                                            class="ccCaption position-absolute bg-white d-flex align-items-center justify-content-center">
                                            <div class="w-100 py-3 px-3">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 mimItem px-xl-4">
                            ...
                            <article class="collectionColumn mb-6 mb-xl-8 text-center position-relative">
                                <div class="imgHolder">
                                    <a href="single-works.html">
                                        <img src="http://via.placeholder.com/365x530" class="img-fluid w-100 d-block"
                                            alt="image description">
                                        <div
                                            class="ccCaption position-absolute bg-white d-flex align-items-center justify-content-center">
                                            <div class="w-100 py-3 px-3">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 mimItem px-xl-4">
                            ...
                            <article class="collectionColumn mb-6 mb-xl-8 text-center position-relative">
                                <div class="imgHolder">
                                    <a href="single-works.html">
                                        <img src="http://via.placeholder.com/365x340" class="img-fluid w-100 d-block"
                                            alt="image description">
                                        <div
                                            class="ccCaption position-absolute bg-white d-flex align-items-center justify-content-center">
                                            <div class="w-100 py-3 px-3">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 mimItem px-xl-4">
                            ...
                            <article class="collectionColumn mb-6 mb-xl-8 text-center position-relative">
                                <div class="imgHolder">
                                    <a href="single-works.html">
                                        <img src="http://via.placeholder.com/365x510" class="img-fluid w-100 d-block"
                                            alt="image description">
                                        <div
                                            class="ccCaption position-absolute bg-white d-flex align-items-center justify-content-center">
                                            <div class="w-100 py-3 px-3">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 mimItem px-xl-4">
                            ...
                            <article class="collectionColumn mb-6 mb-xl-8 text-center position-relative">
                                <div class="imgHolder">
                                    <a href="single-works.html">
                                        <img src="http://via.placeholder.com/365x320" class="img-fluid w-100 d-block"
                                            alt="image description">
                                        <div
                                            class="ccCaption position-absolute bg-white d-flex align-items-center justify-content-center">
                                            <div class="w-100 py-3 px-3">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 mimItem px-xl-4">
                            ...
                            <article class="collectionColumn mb-6 mb-xl-8 text-center position-relative">
                                <div class="imgHolder">
                                    <a href="single-works.html">
                                        <img src="http://via.placeholder.com/365x330" class="img-fluid w-100 d-block"
                                            alt="image description">
                                        <div
                                            class="ccCaption position-absolute bg-white d-flex align-items-center justify-content-center">
                                            <div class="w-100 py-3 px-3">
                    ...
                    <div class="btnHolder text-center pt-6">
                        <a href="single-works.html" class="btn laodMore btn-outline-light bdr2 btnMidMinWidth">Load
                            More</a>
                    </div>
                </div>
            </div>
